	...
	<div class="wrapper theme-1-active pimary-color-red">
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a href="<?php echo base_url()?>ps/home">
						<div class="pull-left">
				...
				<li>
					<a href="<?php echo base_url()?>ps/home/approval">
						<div class="pull-left">
				...
				<li>
					<a href="<?php echo base_url()?>ps/karyawan">
						<div class="pull-left">
							<i class="fa fa-bullseye mr-20"></i>
							<span class="right-nav-text">Karyawan</span>
						</div>
						<div class="clearfix"></div>
					</a>
				</li>
				<li>
					<a href="<?php echo base_url()?>ps/karyawan/cuti_bersama">
						<div class="pull-left">
							<i class="fa fa-bank mr-20"></i>
							<span class="right-nav-text">Cuti Bersama</span>
						</div>
						<div class="clearfix"></div>
					</a>
				</li>
				<li>
					<a href="<?php echo base_url()?>ps/karyawan/pengajuan">
						<div class="pull-left">
