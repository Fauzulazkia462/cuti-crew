...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row bg-title">
			<h4 class="page-title">Pengurangan Cuti</h4>
					...
					<div class="table-responsive">
						...
						<button style="margin-bottom: 20px" data-toggle="collapse" data-target="#collapseExample"
							aria-expanded="false" aria-controls="collapseExample" class="btn btn-primary"><i
								class="fa fa-search mr-20"></i>Upload Data Pengurangan Cuti</button>
						...
						<div class="collapse" id="collapseExample">
							<div class="card card-body">
								...
								<p>Download Template Excel <a
										href='<?php echo base_url()?>excel/pengurangan_cuti.xls'>disini</a></p><br>
								<?php echo form_open_multipart('ps/home/upload_pengurangan_cuti/');?>
