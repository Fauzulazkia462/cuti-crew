...
class Cuti_khusus extends CI_Controller
{
    ...
    public function do_insert()
    {
		...
		// Email subject
        $mail_sub="Pengajuan Cuti Khusus - NIK ".$nik;
        ...
        // Email body content
        $mailContent = "Berdasarkan Data Dibawah Ini<br>NIK : " . $nik . "<br>Nama : " . $nama . "<br>Jenis Pengajuan : Cuti Khusus<br>Kategori : " . $kategori . "<br>Tanggal Mulai : " . $tgl_mulai . "<br>
						Tanggal berahir : " . $tgl_berakhir . "<br>Jumlah Hari : " . $value. "<br>Keterangan : " . $keterangan."<br>Silahkan Login <a href='https://cuticrew.niramasutama.com/'>Disini 
						</a> Untuk Approval";
