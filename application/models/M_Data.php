...
class M_Data extends CI_Model {
	...
	function data_saldo_cuti($number,$offset){
		return $query = $this->db->query("select *, karyawan.nama_karyawan from saldo_cuti join karyawan on saldo_cuti.nik=karyawan.nik limit $number, $offset")->result();		
